...
Customini is an app that seeks to emulate the car customizers you see on car company cororate sites.  I built this site to get extra pratice with using Sass/CSS, AngularJS, and the Foundation framework.
